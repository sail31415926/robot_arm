...
title(sprintf('eMeetArm 末端可达点云（%d 点，按 Z 着色）', numel(idx)));
...
xlabel('X (m)'); ylabel('Y (m)'); zlabel('Z (m)');
title(sprintf('eMeetArm 可达空间等值面  (体素 %.0f mm, N=%d)', vRes*1000, N));
